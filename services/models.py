...
class Song(BaseModel):
    ...
    $ curl -X DELETE -v -H "Accept: application/json" http://127.0.0.1:8888/song/?slug=1
    $ curl -X PUT -v -H "Accept: application/json" -d '{"slug":"33","song":"All of Me Update"}' http://127.0.0.1:8888/song/
    $ curl -X PATCH -v -H "Accept: application/json" -d '{"song":"All of Me UpdatePatch"}' http://127.0.0.1:8888/song/54746cc6d1e5ba151cd46269
